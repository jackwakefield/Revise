...
namespace Revise.Files {
    /// <summary>
    /// Provides the ability to create, open and save IDX files.
    /// </summary>
    public class IDX : FileLoader {
        #region Properties
        ...
        /// </summary>
        public List<VirtualFileSystem> FileSystems {
            get;
            private set;
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Revise.Files.IDX"/> class.
        /// </summary>
        public IDX() {
            FileSystems = new List<VirtualFileSystem>();
        ...
        public override void Load(Stream stream) {
            ...
            for (int i = 0; i < fileSystemCount; i++) {
                ...
                for (int j = 0; j < fileCount; j++) {
                    VirtualFileEntry file = new VirtualFileEntry();
        ...
        public override void Save(Stream stream) {
            ...
            for (int i = 0; i < FileSystems.Count; i++) {
                VirtualFileSystem fileSystem = FileSystems[i];
