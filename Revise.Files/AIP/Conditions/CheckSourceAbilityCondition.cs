...
namespace Revise.Files {
    /// <summary>
    /// Represents a condition to check the source character abilities.
    /// </summary>
    public class CheckSourceAbilityCondition : IArtificialIntelligenceCondition {
        #region Properties
        ...
        public ArtificialIntelligenceConditions Type {
            get {
                return ArtificialIntelligenceConditions.CheckSourceAbility;
            }
        }
        ...
        /// <summary>
        /// Gets or sets the comparison operator to use when comparing <see cref="Ability"/> to <see cref="Value"/>.
        /// </summary>
