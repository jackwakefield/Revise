...
namespace Revise.Files {
    ...
    public class CheckHealthCondition : IArtificialIntelligenceCondition {
        ...
        public ArtificialIntelligenceConditions Type {
            get {
                return ArtificialIntelligenceConditions.CheckHealth;
            }
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to check if the source characters health or more or less than the <see cref="Health" /> value.
        /// </summary>
        public bool More {
            get;
            set;
