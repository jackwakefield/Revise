...
namespace Revise.Files {
    ...
    /// </summary>
    public class FightOrDelayCondition : IArtificialIntelligenceCondition {
        #region Properties
        ...
        public ArtificialIntelligenceConditions Type {
            get {
                return ArtificialIntelligenceConditions.FightOrDelay;
            }
        }

        /// <summary>
        /// Gets or sets a value indicating whether to delay or fight.
        /// </summary>
        public bool Delay {
            get;
            set;
