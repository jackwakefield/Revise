...
namespace Revise.Files {
    /// <summary>
    /// Represents a condition to select the specified NPC.
    /// </summary>
    public class SelectNPCCondition : IArtificialIntelligenceCondition {
        #region Properties
        ...
        public ArtificialIntelligenceConditions Type {
            get {
                return ArtificialIntelligenceConditions.SelectNPC;
            }
        }
