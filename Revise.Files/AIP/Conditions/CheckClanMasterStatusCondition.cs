...
namespace Revise.Files.AIP.Conditions {
    /// <summary>
    /// Represents a condition to check if the target is a clan master.
    /// </summary>
    public class CheckTargetClanStatusCondition : IArtificialIntelligenceCondition {
        #region Properties
        ...
        public ArtificialIntelligenceConditions Type {
            get {
                return ArtificialIntelligenceConditions.CheckTargetClanStatus;
            }
        }
