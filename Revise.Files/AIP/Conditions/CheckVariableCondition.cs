...
namespace Revise.Files {
    /// <summary>
    /// Represents a condition to check the specified variable.
    /// </summary>
    public class CheckVariableCondition : IArtificialIntelligenceCondition {
        #region Properties
        ...
        public ArtificialIntelligenceConditions Type {
            get {
                return ArtificialIntelligenceConditions.CheckVariable;
            }
        }
