...
namespace Revise.Files.AIP.Conditions {
    /// <summary>
    /// Represents a condition to check the current week day and time.
    /// </summary>
    public class CheckWeekDayAndTimeCondition : IArtificialIntelligenceCondition {
        #region Properties
        ...
        public ArtificialIntelligenceConditions Type {
            get {
                return ArtificialIntelligenceConditions.CheckWeekDayAndTime;
            }
        }
