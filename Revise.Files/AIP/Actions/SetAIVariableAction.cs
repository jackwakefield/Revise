...
namespace Revise.Files.AIP.Actions {
    /// <summary>
    /// Represents an action to set the specified AI variable.
    /// </summary>
    public class SetAIVariableAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.SetAIVariable;
            }
        }
