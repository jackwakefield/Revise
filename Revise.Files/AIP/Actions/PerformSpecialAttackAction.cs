...
namespace Revise.Files.AIP.Actions {
    /// <summary>
    /// Represents an action to perform a special attack.
    /// </summary>
    public class PerformSpecialAttackAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.PerformSpecialAttack;
            }
        }
