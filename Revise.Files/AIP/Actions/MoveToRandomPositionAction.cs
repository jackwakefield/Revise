...
namespace Revise.Files {
    /// <summary>
    /// Represents an action to move to a random position within the specified distance.
    /// </summary>
    public class MoveToRandomPositionAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.MoveToRandomPosition;
            }
        }
