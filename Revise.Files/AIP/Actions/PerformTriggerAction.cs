...
namespace Revise.Files.AIP.Actions {
    ...
    /// </summary>
    public class PerformTriggerAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.PerformTrigger;
            }
        }

        /// <summary>
        /// Gets or sets the Lua trigger function name.
        /// </summary>
        ...
        public void Read(BinaryReader reader) {
            ...
            Trigger = reader.ReadShortString();
        }
        ...
        public void Write(BinaryWriter writer) {
            writer.WriteShortString(Trigger);
        }
    }
}