...
namespace Revise.Files.AIP.Actions {
    /// <summary>
    /// Represents an action to attack the nearest character.
    /// </summary>
    public class AttackNearestCharacterAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.AttackNearestCharacter;
            }
        }
