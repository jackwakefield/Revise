...
namespace Revise.Files.AIP.Actions {
    /// <summary>
    /// Represents an action to set the specified NPC variable.
    /// </summary>
    public class SetNPCVariableAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.SetNPCVariable;
            }
        }
