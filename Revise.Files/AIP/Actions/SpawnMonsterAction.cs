...
namespace Revise.Files {
    /// <summary>
    /// Represents an action to spawn the specified monster.
    /// </summary>
    public class SpawnMonsterAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.SpawnMonster;
            }
        }
