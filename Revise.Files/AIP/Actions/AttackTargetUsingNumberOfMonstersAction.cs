...
namespace Revise.Files {
    /// <summary>
    /// Represents an action to attack the target with a maximum number of monsters within the specified distances.
    /// </summary>
    public class AttackTargetUsingNumberOfMonstersAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.AttackTargetUsingNumberOfMonsters;
            }
        }
