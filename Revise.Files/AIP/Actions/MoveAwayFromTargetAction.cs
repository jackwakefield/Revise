...
namespace Revise.Files.AIP.Actions {
    /// <summary>
    /// Represents an action to move a specified distance away from the target.
    /// </summary>
    public class MoveAwayFromTargetAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.MoveAwayFromTarget;
            }
        }
