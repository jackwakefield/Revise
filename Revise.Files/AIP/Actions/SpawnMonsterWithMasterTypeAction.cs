...
namespace Revise.Files.AIP.Actions {
    /// <summary>
    /// Represents an action to spawn the specified monster and set the master status.
    /// </summary>
    public class SpawnMonsterWithMasterTypeAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.SpawnMonsterWithMasterType;
            }
        }
