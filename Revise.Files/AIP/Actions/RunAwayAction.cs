...
namespace Revise.Files.AIP.Actions {
    /// <summary>
    /// Represents an action to run away to the specified distance.
    /// </summary>
    public class RunAwayAction : IArtificialIntelligenceAction {
        #region Properties
        ...
        public ArtificialIntelligenceActions Type {
            get {
                return ArtificialIntelligenceActions.RunAway;
            }
        }

        /// <summary>
        /// Gets or sets the distance to run to.
        /// </summary>
        public int Distance {
            get;
            set;
