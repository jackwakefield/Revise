...
namespace Revise.PTL.Events {
    /// <summary>
    /// Represents an event to change the rotation angle value of the particle.
    /// </summary>
    public class RotationEvent : ParticleEvent {
        #region Properties
        ...
        public override ParticleEventType Type {
            get {
                return ParticleEventType.Rotation;
            }
        }
        ...
        public override void Write(BinaryWriter writer) {
            ...
            writer.Write(Angle.Minimum);
            writer.Write(Angle.Maximum);
        }
    }
}