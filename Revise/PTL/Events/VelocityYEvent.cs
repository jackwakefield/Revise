...
namespace Revise.PTL.Events {
    /// <summary>
    /// Represents an event to change the Y axis velocity of the particle.
    /// </summary>
    public class VelocityYEvent : ParticleEvent {
        #region Properties
        ...
        public override ParticleEventType Type {
            get {
                return ParticleEventType.VelocityY;
            }
        }
        ...
        public override void Read(BinaryReader reader) {
            ...
            Velocity = new MinMax<float>(reader.ReadSingle(), reader.ReadSingle());
        }
