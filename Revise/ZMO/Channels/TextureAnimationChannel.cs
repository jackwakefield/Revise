...
namespace Revise.ZMO.Channels {
    /// <summary>
    /// Represents a texture animation channel.
    /// </summary>
    public class TextureAnimationChannel : MotionChannel {
        #region Properties
        ...
        public override ChannelType Type {
            get {
                return ChannelType.TextureAnimation;
            }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextureAnimationChannel"/> class.
        /// </summary>
        public TextureAnimationChannel() {
            frames = new float[0];
        }
